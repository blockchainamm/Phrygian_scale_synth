# Program to generate the sounds of notes of a phrygian scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a phrygian scale
    notes_interval = [1, 2, 2, 2, 1, 2, 2, 1]  #1 - 2 - 2 - 2 - 1 - 2 - 2
...
# Scale list for which the phrygian scale will be played in sequence
